...
int main()
{
    ...
    while ((PC >= 0) && (PC < inputcode.size()))
    {
       ...
       //    //I-FORMAT OPERATION
       //    //✧∘* ✧･ﾟ✧∘* ✧･ﾟ✧∘✧∘*
        else if (function == "addi" || function == "slti" || function == "sltiu" || function == "xori" || function == "ori" || function == "andi" || function == "slli" || function == "srli" || function == "srai")
        {
            IFormat instruction;
            instruction.instr = adjustedcode[0];
            instruction.rd = adjustedcode[1];
...
void execute(UJFormat I, int& pc)
{
    ...
    else if (I.instr == "auipc") // add Upper Immediate to Program Counter
    {
